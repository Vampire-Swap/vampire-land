    ...
    <footer class="p-10 footer bg-neutral text-neutral-content lg:mt-12 mt-5 rounded-lg">
        ...
        <div>
            ...
            <div class="grid grid-flow-col gap-6">
                ...
                <a>
                    <fa-icon :icon="['fab', 'telegram-plane']" size="2x"></fa-icon>
                </a>
                <a>
